  ...
  return (
    ...
    >
      ...
      <section className="text-center mb-5" style={{ maxWidth: "900px" }}>
        ...
        <p className="lead fs-4 text-white" style={{ maxWidth: "600px", margin: "auto" }}>
      ...
      <section className="text-center" style={{ width: "100%", maxWidth: "600px" }}>
        ...
        >
          ...
          <h3 className="fs-2 text-white mb-3" style={{ textShadow: "0 0 4px rgba(0,0,0,0.7)" }}>
            {title}
          </h3>
          <p className="fs-5 text-white" style={{ lineHeight: 1.5, maxWidth: "450px", margin: "auto" }}>
            {description}
          </p>
        </animated.div>
